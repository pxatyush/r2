...
public class AppPrefs {
    ...
    public boolean isPersistentPlayingEnabled()           { return sp.getBoolean(PERSISTENT, false); }
    public void    setPersistentPlayingEnabled(boolean v) { sp.edit().putBoolean(PERSISTENT, v).apply(); }
